...
def get_symlinks_paths(case_dir, train_folder, labels_folder):
    """
    ...
    def _generate_dst_fname(f, is_label):
        ...
        if is_label:
            return f"{labels_folder}/{basename(case_dir)}_{frame_num}.png"
        else:
            return f"{train_folder}/{basename(case_dir)}_{frame_num}_0000.png"
