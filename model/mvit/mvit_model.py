...
from model.mvit.attention import MultiScaleBlock
from model.mvit.common import round_width
...
# https://github.com/facebookresearch/mvit/blob/main/mvit/models/mvit_model.py
