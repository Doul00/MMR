...
TEST_LISTFILE=$ROOT_DIR/data/splits_final/test_debug.txt
CHECKPOINT_PATH="/nfs/home/aamadou/Projects/MMR/output/logs/train-m2f-full-no-aug/weights/best.ckpt"
